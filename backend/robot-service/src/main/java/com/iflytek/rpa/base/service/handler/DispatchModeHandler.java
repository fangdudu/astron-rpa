...
public class DispatchModeHandler implements ParamModeHandler {
    ...
    private AppResponse<List<ParamDto>> handleDataSource(RobotExecute executeInfo, String processId, String moduleId, Integer enabledVersion) {
        // 指定版本
    ...
    @NotNull
    private AppResponse<List<ParamDto>> createProcessHandle(RobotExecute executeInfo, String processId, Integer enabledVersion) {
